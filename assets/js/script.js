$(document).ready(function() {
    ...
    for (const key in inputData) {
        ...
        for (const innerKey in inputData[key]) {
            ...
            // // function for supporting special ui strings with function.
            // if(inputData['th'][innerKey] && inputData['en'][innerKey])
            // {
            //      cellValue = {
